...
import Toolbar from "@material-ui/core/Toolbar";
import { Table, TableHead, TableRow, TableCell, Checkbox, TableBody, Tooltip, IconButton, TableFooter, TablePagination } from "@material-ui/core";
            ...
            <Paper>
                <Toolbar>
                    <div>
                        {this.state.itemsToDelete.length > 0 ? 
                            <Typography variant="h6">{this.state.itemsToDelete.length + " items selected"}</Typography>
                            :
                ...
                <div>
                    <Table>
                        <TableHead>
                            <TableRow>
                                <TableCell padding="checkbox" className={classes.tableCheckbox}>
                                    <Checkbox
                                        checked={this.state.itemsToDelete.length === this.state.items.length} 
                        ...
                        <TableBody>
                            {this.state.items.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((e,index) => {
                                return (
                                    <TableRow key={index} hover>
                                        <TableCell padding="checkbox" className={classes.tableCheckbox}>
                                            <Checkbox
                                                checked={this.state.itemsToDelete.includes(e.id)} 
                                                onChange={() => {this.addToDelete(e.id)}}
                                            />
                                        </TableCell>
                                        <TableCell align="left" className={classes.tableName}>
