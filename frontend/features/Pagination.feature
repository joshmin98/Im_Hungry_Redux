...
Scenario: Navigating to page 10 (demonstrating the sliding window)
  Given I am logged in and on the home page
  When I enter "burger" in the "#food" text box
  And I enter "15" in the "#distance" text box
  And I enter "50" in the "#limit" text box
  And I click the "#feedME" button
  Then I will transition to the Results Page and wait
  When I click the "10" button on the pagination selector
  Then I will see the item with the ID "jdSDjkfdsitM976BhsdzbQ" as the "first" item in "restaurants"
  And I will see the item with the ID "dDj898" as the "first" item in "recipes"
