...
Given('{string} for the number of results to be displayed', async function (string) {
...
Then('the page will have a collage of photos related to the search query', async function () {
  await checkList('#images');
  return 'success';
});

Then('the page will have a dropdown box with the predefined lists', async function () {
...
Then('the page will have two columns of results titled: Restaurants, Recipes', function () {
  // Write code here that turns the phrase above into concrete actions
  return 'pending';
});

Then('the page will have {int} restaurant and recipe results in each column', function (int) {
  // Write code here that turns the phrase above into concrete actions
  return 'pending';
});

Then('each restaurant item on the page will have an address, name, and minutes', function () {
  // Write code here that turns the phrase above into concrete actions
  return 'pending';
});

Then('each recipe item on the page will have a name, prep time, and cook time', function () {
  // Write code here that turns the phrase above into concrete actions
  return 'pending';
});
...
Then('I will be on the Restaurant Page of restaurant {string}', function (string) {
  // Write code here that turns the phrase above into concrete actions
  return 'pending';
});
