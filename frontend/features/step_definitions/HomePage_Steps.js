...
When('I enter {string} into the text box labeled: Enter Food', async function (string) {
    await fillInTextField('#food', string);
    return 'success';
});

When('I enter a number greater than or equal to {string} into the text box labeled: Distance', async function (string) {
    await fillInTextField('#distance', string); 
    return 'success';
});
       
When('I enter a number greater than or euqal to {string} into the text box labeled: Limit', async function (string) {
